...
static const _IntervalStamped_type_support_symbol_names_t _IntervalStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interval_analysis_interfaces, msg, IntervalStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interval_analysis_interfaces, msg, IntervalStamped)),
  }
};
...
{
  return &::interval_analysis_interfaces::msg::rosidl_typesupport_cpp::IntervalStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interval_analysis_interfaces, msg, IntervalStamped)() {
  return get_message_type_support_handle<interval_analysis_interfaces::msg::IntervalStamped>();
}
