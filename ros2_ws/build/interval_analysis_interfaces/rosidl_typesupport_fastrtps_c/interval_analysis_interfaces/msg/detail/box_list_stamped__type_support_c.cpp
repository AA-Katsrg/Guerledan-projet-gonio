...
#include "interval_analysis_interfaces/msg/detail/box_list_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _BoxListStamped__ros_msg_type = interval_analysis_interfaces__msg__BoxListStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BoxListStamped__ros_msg_type * ros_message = static_cast<const _BoxListStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BoxListStamped__ros_msg_type * ros_message = static_cast<_BoxListStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_interval_analysis_interfaces__msg__BoxListStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoxListStamped__ros_msg_type * ros_message = static_cast<const _BoxListStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoxListStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interval_analysis_interfaces__msg__BoxListStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interval_analysis_interfaces
size_t max_serialized_size_interval_analysis_interfaces__msg__BoxListStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interval_analysis_interfaces__msg__BoxListStamped;
    is_plain =
      (
...
static size_t _BoxListStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interval_analysis_interfaces__msg__BoxListStamped(
...
static message_type_support_callbacks_t __callbacks_BoxListStamped = {
...
static rosidl_message_type_support_t _BoxListStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BoxListStamped,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interval_analysis_interfaces, msg, BoxListStamped)() {
  return &_BoxListStamped__type_support;
}
