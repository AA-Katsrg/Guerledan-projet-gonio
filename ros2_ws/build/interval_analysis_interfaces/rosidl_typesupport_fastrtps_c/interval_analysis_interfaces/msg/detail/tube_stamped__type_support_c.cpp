...
#include "interval_analysis_interfaces/msg/detail/tube_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _TubeStamped__ros_msg_type = interval_analysis_interfaces__msg__TubeStamped;

static bool _TubeStamped__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TubeStamped__ros_msg_type * ros_message = static_cast<const _TubeStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _TubeStamped__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TubeStamped__ros_msg_type * ros_message = static_cast<_TubeStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_interval_analysis_interfaces__msg__TubeStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TubeStamped__ros_msg_type * ros_message = static_cast<const _TubeStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TubeStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interval_analysis_interfaces__msg__TubeStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interval_analysis_interfaces
size_t max_serialized_size_interval_analysis_interfaces__msg__TubeStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interval_analysis_interfaces__msg__TubeStamped;
    is_plain =
      (
...
static size_t _TubeStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_interval_analysis_interfaces__msg__TubeStamped(
...
static message_type_support_callbacks_t __callbacks_TubeStamped = {
  "interval_analysis_interfaces::msg",
  "TubeStamped",
  _TubeStamped__cdr_serialize,
  _TubeStamped__cdr_deserialize,
  _TubeStamped__get_serialized_size,
  _TubeStamped__max_serialized_size
};

static rosidl_message_type_support_t _TubeStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TubeStamped,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interval_analysis_interfaces, msg, TubeStamped)() {
  return &_TubeStamped__type_support;
}
