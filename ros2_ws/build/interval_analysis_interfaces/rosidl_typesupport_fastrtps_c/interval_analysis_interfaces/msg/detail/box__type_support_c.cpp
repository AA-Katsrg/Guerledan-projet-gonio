...
#include "interval_analysis_interfaces/msg/detail/box__rosidl_typesupport_fastrtps_c.h"
...
using _Box__ros_msg_type = interval_analysis_interfaces__msg__Box;
...
static uint32_t _Box__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interval_analysis_interfaces__msg__Box(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interval_analysis_interfaces__msg__Box;
    is_plain =
      (
...
static size_t _Box__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interval_analysis_interfaces__msg__Box(
