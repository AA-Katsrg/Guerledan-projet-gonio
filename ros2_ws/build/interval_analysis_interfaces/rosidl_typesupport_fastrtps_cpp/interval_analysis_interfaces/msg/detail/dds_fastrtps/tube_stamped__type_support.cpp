...
#include "interval_analysis_interfaces/msg/detail/tube_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interval_analysis_interfaces::msg::TubeStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interval_analysis_interfaces::msg::TubeStamped & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interval_analysis_interfaces
max_serialized_size_TubeStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interval_analysis_interfaces::msg::TubeStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interval_analysis_interfaces::msg::TubeStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interval_analysis_interfaces::msg::TubeStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TubeStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interval_analysis_interfaces::msg::TubeStamped *>(
...
static size_t _TubeStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TubeStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TubeStamped__callbacks = {
...
static rosidl_message_type_support_t _TubeStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TubeStamped__callbacks,
...
{
  return &interval_analysis_interfaces::msg::typesupport_fastrtps_cpp::_TubeStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interval_analysis_interfaces, msg, TubeStamped)() {
  return &interval_analysis_interfaces::msg::typesupport_fastrtps_cpp::_TubeStamped__handle;
}
