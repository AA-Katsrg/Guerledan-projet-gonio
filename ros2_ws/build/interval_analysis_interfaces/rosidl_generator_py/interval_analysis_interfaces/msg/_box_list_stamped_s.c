...
bool interval_analysis_interfaces__msg__box_list_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interval_analysis_interfaces.msg._box_list_stamped.BoxListStamped", full_classname_dest, 65) == 0);
  }
  interval_analysis_interfaces__msg__BoxListStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BoxListStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interval_analysis_interfaces.msg._box_list_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoxListStamped");
