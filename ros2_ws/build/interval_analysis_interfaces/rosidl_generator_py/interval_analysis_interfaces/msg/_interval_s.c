...
bool interval_analysis_interfaces__msg__interval__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interval_analysis_interfaces.msg._interval.Interval", full_classname_dest, 51) == 0);
  }
  interval_analysis_interfaces__msg__Interval * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of Interval */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interval_analysis_interfaces.msg._interval");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Interval");
