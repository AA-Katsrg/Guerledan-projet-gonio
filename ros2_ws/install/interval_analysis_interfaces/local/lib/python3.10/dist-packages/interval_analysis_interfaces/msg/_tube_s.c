...
bool interval_analysis_interfaces__msg__tube__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interval_analysis_interfaces.msg._tube.Tube", full_classname_dest, 43) == 0);
  }
  interval_analysis_interfaces__msg__Tube * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of Tube */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interval_analysis_interfaces.msg._tube");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tube");
